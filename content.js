...
const routines = [
{ id: "lunge", title: "Forward Lunges", duration: 30, steps: "1. Step forward.\n2. Lower hips.", localPath: "videos/lunge.mp4", remoteUrl: CLOUD_VIDEO_BASE + "lunge.mp4" },
{ id: "wall_squat", title: "Wall Squat", duration: 30, steps: "1. Lean against the wall.\n2. Hold 90 degrees.", localPath: "videos/wall_squat.mp4", remoteUrl: CLOUD_VIDEO_BASE + "wall_squat.mp4" },
{ id: "jump", title: "Jumping Jacks", duration: 15, steps: "1. Feet together.\n2. Jump wide, hands up.", localPath: "videos/jump.mp4", remoteUrl: CLOUD_VIDEO_BASE + "jump.mp4" },
{ id: "climber", title: "Mountain Climbers", duration: 30, steps: "1. Plank position.\n2. Drive knees to chest rapidly.", localPath: "videos/climber.mp4", remoteUrl: CLOUD_VIDEO_BASE + "climber.mp4" },
{ id: "stretch", title: "Chest Stretch", duration: 30, steps: "1. Pull elbows back bent.\n2. Extend arms wide in T-shape.", localPath: "videos/stretch.mp4", remoteUrl: CLOUD_VIDEO_BASE + "stretch.mp4" }
];
